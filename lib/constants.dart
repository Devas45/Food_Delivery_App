...
class FoodItems {
  String imgUrl, title;
  FoodItems({required this.imgUrl, required this.title});
}
...
List<Restaurants> restaurantList = [
  ...
  Restaurants(
    ...
    price: "150",
    rating: "4.1",
    imgUrl: "https://www.newfoodmagazine.com/wp-content/uploads/mcdonalds.jpg",
  ),
  Restaurants(
    ...
    price: "100",
    rating: "4.2",
    imgUrl: "https://images.indianexpress.com/2020/04/jalebis-759.jpg",
  ),
  Restaurants(
    title: "Burger King",
    id: 6,
